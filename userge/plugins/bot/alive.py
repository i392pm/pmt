...
async def send_alive_message(message: Message) -> None:
    ...
    if client.is_bot:
        ...
        caption += (
            ...
            "    <code>|</code>    "
            "👥  <a href='https://t.me/Team_Librarian'><b>「✧Support✧」</b></a>"
        )
...
class Bot_Alive:
    ...
    def alive_info() -> str:
        alive_info_ = f"""
<a href="https://t.me/Team_Librarian/42"><b>Tiger</a> Is On Hunting🐅</b>

  𓆙   <b>Python:</b>    <code>v{versions.__python_version__}</code>
  🔥   <b>Pyrogram:</b>    <code>v{versions.__pyro_version__}</code>
  🧬   <b>༆𝙻𝙸𝙱 𝚅2:</b>    <code>v{get_version()}</code>
...
"""
    ...
    def alive_buttons() -> InlineKeyboardMarkup:
        buttons = [
            [
                InlineKeyboardButton(text="「✧SETING✧」", callback_data="settings_btn"),
